...
3. Resolve this skill's directory from the path used to load `SKILL.md`, then run:
...
- Recalled excerpts enter the current Codex context and may be processed by the model backing this session.
